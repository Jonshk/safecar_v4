...
class AppTheme {
  ...
  // ── Typography ───────────────────────────────────────────────
  static TextStyle display(double size, {FontWeight w = FontWeight.w800, Color color = white}) =>
      GoogleFonts.barlow(fontSize: size, fontWeight: w, color: color, letterSpacing: -0.5);

  static TextStyle mono(double size, {FontWeight w = FontWeight.w500, Color color = white}) =>
      GoogleFonts.ibmPlexMono(fontSize: size, fontWeight: w, color: color);

  static TextStyle body(double size, {FontWeight w = FontWeight.w400, Color color = white80}) =>
